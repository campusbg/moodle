...
//poner la imagen de fondo subida desde eguru
    if(!empty($imgback)){
    echo html_writer::start_tag('img', array('class' => 'col-md-12','style' => 'position: fixed; /*opacity: 0.5;*/ height: 128%; width: 100%; max-width: 1366px;  top: -2%;', 'src' => '//campusbg.bancoguayaquil.com/campusbg/pluginfile.php/1/theme_eguru/imgbackdefault/1532644209' . $imgback , 'alt' => ''));
    }
        $html = html_writer::start_tag('header', array('id' => 'page-header', 'class' => 'row'));
        $html .= html_writer::start_div('col-xs-12 p-a-1');
        $html .= html_writer::start_div('card', array('style' => 'background-color: transparent;'));
        $html .= html_writer::start_div('card-block');
        $html .= html_writer::div($this->context_header_settings_menu(), 'pull-xs-right context-header-settings-menu');
        $html .= html_writer::start_div('pull-xs-right');
        //$html .= html_writer::tag('h3',strftime("%A,%d de %B del %Y"), array('style' => 'margin-right:20px;'));
        $html .= html_writer::tag('h3',strftime("%d/%m/%Y"), array('style' => 'margin-right:20px;'));
        $html .= html_writer::end_div();
        $html .= html_writer::start_div('pull-xs-left');
        $html .= $this->context_header();
	//$html .= html_writer::tag('h3',strftime("%A, %d de %B de %Y"));
//	$html .= html_writer::tag('h3',date("Y-M-d"));
     ...
     */
    public function context_header($headerinfo = null, $headinglevel = 3) {
        global $SITE;

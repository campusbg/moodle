...
function slideshow() {
    ...
    if ($numberofslides) {
        $content = html_writer::start_tag('div', array('class' => 'homepage-carousel'));
            ...
            $content .= html_writer::start_tag('div', array('id' => 'home-page-carousel', 'class' => 'carousel slide', '
                data-ride' => 'carousel'));
            ...
            for ($s = 0; $s < $numberofslides; $s++):
                ...
                $content .= html_writer::start_tag('li', array('data-target
                    ' => '#home-page-carousel', 'data-slide-to' => $s.$clstxt));
            ...
            for ($s1 = 1; $s1 <= $numberofslides; $s1++):
                ...
                $content .= html_writer::start_tag('div', array('
                    class' => 'carousel-item'.$clstxt2, 'style
		    ...
		    'id' => 'slide'));
                ...
                $content .= html_writer::start_tag('a', array('class' => 'left carousel-control', 'href' => '#home-page-carousel', '
                    data-slide' => 'prev'));
                    $content .= html_writer::start_tag('i', array('class' => 'fa fa-caret-left'));
                    $content .= html_writer::end_tag('i');
                $content .= html_writer::end_tag('a');

                $content .= html_writer::start_tag('a', array('
                    class' => 'right carousel-control', 'href' => '#home-page-carousel', 'data-slide' => 'next'));
                    $content .= html_writer::start_tag('i', array('class' => 'fa fa-caret-right'));
                    $content .= html_writer::end_tag('i');
                $content .= html_writer::end_tag('a');

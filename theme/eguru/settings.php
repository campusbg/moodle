...
if (is_siteadmin()) {
    ...
    $themepattern = '<ul class="thumbnails theme-color-schemes"><li class="col-md-2"><div class="thumbnail"><img src="'.$pimg[0].'" alt="default" width="100" height="100"/><h6>'.get_string( "default", 'theme_eguru' ).'</h6></div></li><li class="col-md-2"><div class="thumbnail"><img src="'.$pimg[1].'" alt="pattern1" width="100" height="100"/><h6>'.get_string("color_1", 'theme_eguru').'</h6></div></li><li class="col-md-2"><div class="thumbnail"><img src="'.$pimg[2].'" alt="pattern2" width="100" height="100"/><h6>'.get_string("color_2", 'theme_eguru').'</h6></div></li><li class="col-md-2"><div class="thumbnail"><img src="'.$pimg[3].'" alt="pattern3" width="100" height="100"/><h6>'.get_string("color_3", 'theme_eguru').'</h6></div></li><li class="col-md-2"><div class="thumbnail"><img src="'.$pimg[4].'" alt="pattern4" width="100" height="100"/><h6>'.get_string("color_4", 'theme_eguru').'</h6></div></li></ul>';
    ...
    $temp = new admin_settingpage('theme_eguru_marketingspots', get_string('marketingspotsheading', 'theme_eguru'));
        ...
        $name = 'theme_eguru/imgbackdefault' . 'image';
        $title = 'Imagen de fondo cursos';
        $description = 'Aqui se carga una imagen que aparece como fondo en lso cursos';
        $setting = new admin_setting_configstoredfile($name, $title, $description, 'imgbackdefault');
        $setting->set_updatedcallback('theme_reset_all_caches');
        $temp->add($setting);
    ...
    $temp->add($setting);
        ...
        // Slide Image.
        $name = 'theme_eguru/mspot1title1' . 'image';//este es el setting con el que se guarda en la tabla config_log
        $title = get_string('marketingspot', 'theme_eguru');
        $description = get_string('mspottitledesc', 'theme_eguru');
        $setting = new admin_setting_configstoredfile($name, $title, $description, 'spot1marketing');
        $setting->set_updatedcallback('theme_reset_all_caches');
        $temp->add($setting);
    ...
    $temp->add($setting);
        ...
        // Slide Image.
        $name = 'theme_eguru/mspot1title2' . 'image';
        $title = get_string('marketingspot', 'theme_eguru');
        $description = get_string('mspottitledesc', 'theme_eguru');
        $setting = new admin_setting_configstoredfile($name, $title, $description, 'spot2marketing');
        $setting->set_updatedcallback('theme_reset_all_caches');
        $temp->add($setting);
    ...
    $temp->add($setting);*/
        ...
        // Slide Image.
        $name = 'theme_eguru/mspot1title3' . 'image';
        $title = get_string('marketingspot', 'theme_eguru');
        $description = get_string('mspottitledesc', 'theme_eguru');
        $setting = new admin_setting_configstoredfile($name, $title, $description, 'spot3marketing');
        $setting->set_updatedcallback('theme_reset_all_caches');
        $temp->add($setting);
    ...
    $temp->add($setting);
        ...
        // Slide Image.
        $name = 'theme_eguru/mspot1title4' . 'image';
        $title = get_string('marketingspot', 'theme_eguru');
        $description = get_string('mspottitledesc', 'theme_eguru');
        $setting = new admin_setting_configstoredfile($name, $title, $description, 'spot4marketing');
        $setting->set_updatedcallback('theme_reset_all_caches');
        $temp->add($setting);
    ...
    $description = 'La URL de instagram para su organizaci&oacute;n';
    //$default = get_string('gpurl_default', 'theme_eguru');
    $default = 'https://www.instagram.com/example';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
    ...
    $description = 'La URL de youtube para su organizaci&oacute;n';
    //$default = get_string('pinurl_default', 'theme_eguru');
    $default = 'https://www.youtube.com/example';
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
    /* Footer Block3. */

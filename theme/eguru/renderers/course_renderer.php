...
class theme_eguru_core_course_renderer extends core_course_renderer {
	...
	$promotedtitle = 'Cursos Disponibles';

        $featuredheader = '<div class="custom-courses-list" id="Promoted-Courses">
							  <div class="container">
								<div class="titlebar with-felements">
									<a class="btn-marketing" style="color: #072B4B;">'.strtoupper($promotedtitle).'</a>
                ...
                foreach ($courseids as $courseid) {
                    ...
                    if (empty($imgurl)) {
                        ...
                        $coursehtml = '<div class="col-md-2">
                            ...
                            <div class="thumb" style="border: 0.5px solid;"><a href="'.$courseurl.'">
							<img src="'.$imgurl.'" width="135" height="135" alt="'.$course->fullname.'">';
			$coursehtml .= '</a></div>';
                        $coursehtml .= '<div class="info">
                            <h5><a href="'.$courseurl.'" style="font-size: 0.8em;">'.$course->fullname.'</a></h5>
                            </div>
                            </div>
                            </div>';
